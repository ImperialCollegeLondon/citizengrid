...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CloudInstancesAWS'
        db.delete_table(u'citizengrid_cloudinstancesaws')


    def backwards(self, orm):
        # Adding model 'CloudInstancesAWS'
        db.create_table(u'citizengrid_cloudinstancesaws', (
            ...
            ('application_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['citizengrid.ApplicationEC2Images'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'citizengrid', ['CloudInstancesAWS'])
