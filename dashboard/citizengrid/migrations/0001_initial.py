...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CGView'
        db.create_table(u'citizengrid_cgview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ...
            ('subcategory_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('subcategory_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'citizengrid', ['CGView'])
        ...
        db.create_table(u'citizengrid_applicationbasicinfo', (
            ...
            ('iconfile', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ...
        # Adding model 'Role'
        db.create_table(u'citizengrid_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'citizengrid', ['Role'])

        # Adding model 'MyGroup'
        db.create_table(u'citizengrid_mygroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('group_role', self.gf('django.db.models.fields.CharField')(default='M', max_length=1)),
        ))
        db.send_create_signal(u'citizengrid', ['MyGroup'])

        # Adding M2M table for field user on 'MyGroup'
        m2m_table_name = db.shorten_name(u'citizengrid_mygroup_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mygroup', models.ForeignKey(orm[u'citizengrid.mygroup'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mygroup_id', 'user_id'])

        # Adding model 'GroupApplicationTag'
        db.create_table(u'citizengrid_groupapplicationtag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tagname', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['citizengrid.MyGroup'], null=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['citizengrid.ApplicationBasicInfo'], null=True)),
            ('tagid', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'citizengrid', ['GroupApplicationTag'])
        ...
        # Adding model 'UsersApplications'
        db.create_table(u'citizengrid_usersapplications', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['citizengrid.ApplicationBasicInfo'])),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('run_count', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'citizengrid', ['UsersApplications'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CGView'
        db.delete_table(u'citizengrid_cgview')
        ...
        # Deleting model 'Role'
        db.delete_table(u'citizengrid_role')

        # Deleting model 'MyGroup'
        db.delete_table(u'citizengrid_mygroup')

        # Removing M2M table for field user on 'MyGroup'
        db.delete_table(db.shorten_name(u'citizengrid_mygroup_user'))

        # Deleting model 'GroupApplicationTag'
        db.delete_table(u'citizengrid_groupapplicationtag')
        ...
        # Deleting model 'UsersApplications'
        db.delete_table(u'citizengrid_usersapplications')
    ...
    models = {
        ...
        u'citizengrid.mygroup': {
            ...
            'creation_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'group_role': ('django.db.models.fields.CharField', [], {'default': "'M'", 'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
